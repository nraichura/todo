...
public record ChangeStatusRequestDto(
        @JsonPropertyDescription("Status of the todo item. It could be anything from the allowed values (NOT_DONE, DONE, PAST_DUE). The default value is NOT_DONE") @Nonnull ItemStatus status
) {}
